  ...
  return (
    <main>
      ...
      <Section className="sec-default">
        ...
        <GoButton onClick={()=>navigate('/about')}>Learn More About Us</GoButton>
      </Section>

      <Section className="sec-default">
        <h2>What We're Doing</h2>
        <p>"We don't just supply wine to x number of business - we also host events for, both here and around the Twin Cities."</p>
        <GoButton onClick={()=>navigate('/events')}>See Upcoming Events</GoButton>
      </Section>
      ...
      <Section className="sec-default">
        ...
        <GoButton onClick={()=>navigate('/partners')}>View Our Partners</GoButton>
      </Section>
